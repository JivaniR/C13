...
function spawnObstacles(){
  ...
  if(frameCount% 70 == 0){
    ...
    switch(rand){
case 1: obstacles.addImage("abc", obstacleImg_1)
break;
case 2: obstacles.addImage("abc", obstacleImg_2)
break;
case 3: obstacles.addImage("abc", obstacleImg_3)
break;
case 4: obstacles.addImage("abc", obstacleImg_4)
break;
case 5: obstacles.addImage("abx", obstacleImg_5)
break;
case 6: obstacles.addImage("abc", obstacleImg_6)
break;
default: break
    }
  obstacles.scale= 0.5
